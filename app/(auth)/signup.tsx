...
const styles = StyleSheet.create({
  ...
  hero: { borderRadius: 16, borderWidth: 1, padding: 22, gap: 12 },
  eyebrow: { fontFamily: F.bold, fontSize: 13, textTransform: 'uppercase', letterSpacing: 0 },
  title: { fontFamily: F.bold, fontSize: 30, lineHeight: 38, letterSpacing: 0 },
  subtitle: { fontFamily: F.regular, fontSize: 15, lineHeight: 24 },
  featureGrid: { gap: 10, marginTop: 6 },
  featureCard: { borderWidth: 1, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, flexDirection: 'row', alignItems: 'center', gap: 10 },
