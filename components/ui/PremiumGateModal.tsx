...
const styles = StyleSheet.create({
  ...
  sheet: { borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, paddingBottom: 34, maxHeight: '94%' },
  closeButton: { alignSelf: 'flex-end', padding: 4 },
  headline: { fontFamily: F.bold, fontSize: 26, lineHeight: 34, letterSpacing: 0 },
  subheadline: { fontFamily: F.semiBold, fontSize: 16, marginTop: 6 },
  featureList: { gap: 12, marginTop: 20 },
  featureRow: { flexDirection: 'row', gap: 12, alignItems: 'flex-start' },
  featureText: { fontFamily: F.regular, fontSize: 15, lineHeight: 23, flex: 1 },
  webCard: { borderRadius: 16, borderWidth: 1.5, padding: 18, marginTop: 22, gap: 12, alignItems: 'center' },
  ...
  webBtn: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 18, paddingVertical: 13, borderRadius: 12, marginTop: 4 },
  ...
  testimonialCard: { borderWidth: 1, borderRadius: 16, padding: 16, gap: 10, marginTop: 18 },
  ...
  companyCard: { width: '48%', borderRadius: 12, minHeight: 64, alignItems: 'center', justifyContent: 'center', borderWidth: 1 },
